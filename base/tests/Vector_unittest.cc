...
TEST(Base_UVector, count_UVector)
{

    UVector uVector = create_UVector();

    EXPECT_EQ(-1, count_UVector(NULL));
    EXPECT_EQ(uVector.count, count_UVector(&uVector));
...
TEST(Base_UVector, size_UVector)
{

    UVector uVector = create_UVector();

    EXPECT_EQ(-1, size_UVector(NULL));
    EXPECT_EQ(uVector.size, size_UVector(&uVector));
